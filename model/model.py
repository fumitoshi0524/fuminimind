...
class Attention(nn.Module):
    def __init__(self, args: fuminimindConfig):
        super().__init__()
...
class fuminimindBlock(nn.Module):
...
class fuminimindModel(nn.Module):
    def __init__(self, config: fuminimindConfig):
        ...
        self.dropout = nn.Dropout(config.dropout)
        self.layers = nn.ModuleList([fuminimindBlock(l, config) for l in range(self.num_hidden_layers)])
...
class fuminimindForCausalLM(PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: fuminimindConfig = None):
        self.config = config or fuminimindConfig()
        super().__init__(self.config)
        self.model = fuminimindModel(self.config)
