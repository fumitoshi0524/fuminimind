...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_weight", default="pretrain", type=str, help="prefix for saving weights"
    )
    parser.add_argument(
        "--epochs", type=int, default=1, help="number of training epochs (recommended 1 epoch for zero or 2-6 epochs for full training)"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"fuminimind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
